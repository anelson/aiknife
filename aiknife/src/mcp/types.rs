...
impl From<FooResult> for ClientResult {
    fn from(value: FooResult) -> Self {
        Self::FooResult(value)
    }
}
...
#[doc = r" </details>"]
#[derive(:: serde :: Deserialize, :: serde :: Serialize, Clone, Debug)]
pub struct EmptyResult(pub FooResult);
impl ::std::ops::Deref for EmptyResult {
    type Target = FooResult;
    fn deref(&self) -> &FooResult {
        &self.0
    }
}
impl From<EmptyResult> for FooResult {
...
impl From<FooResult> for EmptyResult {
    fn from(value: FooResult) -> Self {
        Self(value)
    }
}
...
impl From<&FooResult> for FooResult {
    fn from(value: &FooResult) -> Self {
        value.clone()
    }
}
impl FooResult {
    pub fn builder() -> builder::FooResult {
        Default::default()
    }
}
...
impl From<FooResult> for ServerResult {
    fn from(value: FooResult) -> Self {
        Self::FooResult(value)
    }
}
...
pub mod builder {
    ...
    impl ::std::convert::TryFrom<FooResult> for super::FooResult {
        type Error = super::error::ConversionError;
        fn try_from(
            value: FooResult,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
    ...
    impl From<super::FooResult> for FooResult {
        fn from(value: super::FooResult) -> Self {
            Self {
                meta: Ok(value.meta),
            }
        }
    ...
    impl JsonrpcResponse {
        ...
        where
            T: std::convert::TryInto<super::FooResult>,
            T::Error: std::fmt::Display,
        {
            self.result = value
                .try_into()
